 ...
 * SoapWrapper Class
 *
 * Connecting to the SOAP server and calling SOAP function calls
 *
...
class SoapWrapper
{
     ...
     * @param array $soapSettings array containing soapSettings, provided by dependencies/settings
     */
    ...
    /**
     * Gets the current SoapClient
     * @return SoapClient|null Returns the current SoapClient or null if no connection exists
     */
     ...
     * @return bool connection success or failure
     */
    ...
    /**
     * Function for performing desired SOAP function calls
     ...
     * @return mixed|null Results of function call or null if there was an error
     */
